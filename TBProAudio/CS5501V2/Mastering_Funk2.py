...
def create_mastering_funk_preset():
    ...
    # Input/Output settings - slight trim for headroom
    preset.parameters["In Volume L"] = "-0.500000"
    preset.parameters["In Volume R"] = "-0.500000"
    preset.parameters["Out Volume L"] = "-0.200000"
    preset.parameters["Out Volume R"] = "-0.200000"

    # Enhanced filtering for funk's frequency spectrum
    preset.parameters["Filter0 Off/On"] = "1.000000"
    preset.parameters["Filter0 HP Off/On"] = "1.000000"
    preset.parameters["Filter0 HP F"] = "22.000000"  # Lower for more sub presence
    preset.parameters["Filter0 HP Slope 6-48dB"] = "2.000000"  # Gentler slope
    preset.parameters["Filter0 LP Off/On"] = "1.000000"
    preset.parameters["Filter0 LP F"] = "19500.000000"  # Extended highs
    preset.parameters["Filter0 LP Slope 6-48dB"] = "1.000000"

    # Bass enhancement EQ
    preset.parameters["Filter0 LF Off/On"] = "1.000000"
    preset.parameters["Filter0 LF Type"] = "2.000000"  # Pultec-style
    preset.parameters["Filter0 LF F"] = "50.000000"
    preset.parameters["Filter0 LF G"] = "2.800000"
    preset.parameters["Filter0 LF Q"] = "0.900000"

    # Low-mid cleanup for punch
    preset.parameters["Filter0 LMF Off/On"] = "1.000000"
    preset.parameters["Filter0 LMF F"] = "240.000000"  # Higher for better clarity
    preset.parameters["Filter0 LMF G"] = "-2.000000"
    preset.parameters["Filter0 LMF Q"] = "1.200000"

    # Funk-specific compression chain
    # Comp0 - Groove enhancer
    preset.parameters["Comp0 Off/On"] = "1.000000"
    preset.parameters["Comp0 Type"] = "1.000000"  # FET style
    preset.parameters["Comp0 Threshold"] = "-22.000000"
    preset.parameters["Comp0 Ratio"] = "6.000000"
    preset.parameters["Comp0 Attack"] = "2.500000"  # Faster for punch
    preset.parameters["Comp0 Release"] = "65.000000"
    preset.parameters["Comp0 MakeUpGain"] = "4.500000"
    preset.parameters["Comp0 Mix"] = "55.000000"  # More parallel compression

    # Comp1 - Musical glue
    preset.parameters["Comp1 Off/On"] = "1.000000"
    preset.parameters["Comp1 Type"] = "2.000000"  # VCA style
    preset.parameters["Comp1 Threshold"] = "-10.000000"
    preset.parameters["Comp1 Ratio"] = "2.200000"
    preset.parameters["Comp1 Attack"] = "25.000000"  # Slower for natural envelope
    preset.parameters["Comp1 Release"] = "150.000000"
    preset.parameters["Comp1 MakeUpGain"] = "1.800000"
    preset.parameters["Comp1 Mix"] = "100.000000"

    # Refined saturation for funk character
    preset.parameters["Saturation Off/On"] = "1.000000"
    preset.parameters["Saturation Mode"] = "2.000000"  # Tape mode
    preset.parameters["Saturation Stages"] = "3.000000"  # More controlled
    preset.parameters["Saturation Even Harmonics"] = "45.000000"  # More warmth
    preset.parameters["Saturation Odd Harmonics"] = "25.000000"  # Added grit
    preset.parameters["Saturation Fluctuation"] = "12.000000"
    preset.parameters["Saturation Mix"] = "70.000000"

    # Precision limiting
    preset.parameters["Limit0 Off/On"] = "1.000000"
    preset.parameters["Limit0 Gain"] = "1.200000"
    preset.parameters["Limit0 Release"] = "25.000000"  # Faster for transients
    preset.parameters["Limit0 Auto release"] = "1.000000"
    preset.parameters["Limit0 Ceiling"] = "-0.200000"

    # Enhanced midrange presence
    preset.parameters["Filter0 MF Off/On"] = "1.000000"
    preset.parameters["Filter0 MF F"] = "1800.000000"  # Lower for body
    preset.parameters["Filter0 MF G"] = "1.500000"
    preset.parameters["Filter0 MF Q"] = "0.850000"

    # Air and presence
    preset.parameters["Filter0 HMF Off/On"] = "1.000000"
    preset.parameters["Filter0 HMF F"] = "4500.000000"
    preset.parameters["Filter0 HMF G"] = "2.200000"
    preset.parameters["Filter0 HMF Q"] = "0.750000"

    preset.parameters["Filter0 HF Off/On"] = "1.000000"
    preset.parameters["Filter0 HF Type"] = "2.000000"  # Air band
    preset.parameters["Filter0 HF F"] = "12500.000000"
    preset.parameters["Filter0 HF G"] = "2.000000"
    preset.parameters["Filter0 HF Q"] = "0.650000"
